...
import styles from './SimulatedQPayProForm.module.css';
    ...
    return (
        <div className={styles.root}>
            <div className={styles.banner}>
                ...
                <span className={styles.badge}>Visa, Mastercard · Demo</span>
            </div>
            ...
            <p className={styles.text}>
                Al confirmar el pago se simulará la redirección a QPayPRo y la autorización
